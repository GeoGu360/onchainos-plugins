...
/// In dry_run mode: returns a simulated success response without broadcasting.
/// NOTE: onchainos wallet contract-call does NOT support --dry-run; handle it here.
pub async fn wallet_contract_call(
    ...
    // --force required to ensure onchainos broadcasts the transaction
